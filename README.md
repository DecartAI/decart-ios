...
```swift
dependencies: [
    .package(url: "https://github.com/decartai/decart-ios.git", from: "0.6.10")
]
```
...
- `RealtimeModel.lucyVton3` - Previous virtual try-on
...
- `VideoModel.lucyVton3` - Previous virtual try-on video edit
